...
public class RoomRepository {
    ...
    static {
        ...
        if (roomDatabase.isEmpty()) {
             roomDatabase.put(101, new Room(101, "스탠다드", 50000));
             roomDatabase.put(102, new Room(102, "디럭스", 80000));
             roomDatabase.put(103, new Room(103, "스위트", 120000));
             roomDatabase.put(104, new Room(104, "패밀리", 200000));
             roomDatabase.put(105, new Room(105, "스탠다드", 50000));
             roomDatabase.put(106, new Room(106, "디럭스", 80000));
             roomDatabase.put(107, new Room(107, "스탠다드", 50000));
             roomDatabase.put(108, new Room(108, "패밀리", 200000));
             roomDatabase.put(109, new Room(109, "스탠다드", 50000));
             roomDatabase.put(110, new Room(110, "패밀리", 200000));
